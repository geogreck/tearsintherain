# Generated by Django 4.1.2 on 2022-11-16 01:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_comment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tearsapi.comment')),
                ('target_moment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tearsapi.moment')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
